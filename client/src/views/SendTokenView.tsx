...
export default function SendTokenView() {
  ...
  const renderSubmitButton = () => {
    return (<div>
      <button className="group relative flex justify-center btn w-full btn-primary" onClick={generateToken}>Enviar</button>
    </div>)
  }
